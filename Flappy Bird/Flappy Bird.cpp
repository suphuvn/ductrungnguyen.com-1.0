...
void flapMove(struct flappy &bird)
{
     ...
     if(bird.jump == FALSE)
     {
         if(bird.collided == TRUE)
         {
              bird.pos_y = bird.pos_y + int(sin(bird.drop) + cos(bird.drop) * (20));                  
         }
         else
         {
             bird.pos_y = bird.pos_y + int(sin(bird.drop) + cos(bird.drop) * (10));   
         }
         bird.drop+=0.02;                   
     }   
     ...
     if(bird.jump == TRUE)
     {
         bird.pos_y = bird.pos_y + int(sin(bird.interval) + cos(bird.interval) * (9));  
         bird.interval+=0.04;
         if(bird.interval >= 4.8)
         {
             bird.interval = 4;
             bird.jump = FALSE;                
         }                             
